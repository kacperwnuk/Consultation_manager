...
class SuggestConsultationFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        if (startTime != null) {
            ...
            view.start_time.isClickable = false
            view.start_time.isEnabled = false
            view.start_time.isFocusable = false
            ...
            view.end_time.isClickable = false
            view.end_time.isEnabled = false
            view.end_time.isFocusable = false
        }
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(startTime: String?, end_time: String?, lecturer: String?) =
